{{> cards/card_component componentName='liquor-card' }}

class liquor_cardCardComponent extends BaseCard['liquor-card'] {
   ...
   */
   dataForRender(profile) {
    ...
    return {
      ...
      subtitle: profile.c_priceRange, // The sub-header text of the card
  ...
  static defaultTemplateName (config) {
    return 'cards/liquor-card';
  }
}

ANSWERS.registerTemplate(
  'cards/liquor-card',
  {{{stringifyPartial (read 'cards/liquor-card/template') }}}
);
ANSWERS.registerComponentType(liquor_cardCardComponent);
