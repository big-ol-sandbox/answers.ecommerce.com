{{> cards/card_component componentName='beer-card' }}

class beer_cardCardComponent extends BaseCard['beer-card'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/beer-card';
  }
}

ANSWERS.registerTemplate(
  'cards/beer-card',
  {{{stringifyPartial (read 'cards/beer-card/template') }}}
);
ANSWERS.registerComponentType(beer_cardCardComponent);
