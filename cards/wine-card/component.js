{{> cards/card_component componentName='wine-card' }}

class wine_cardCardComponent extends BaseCard['wine-card'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/wine-card';
  }
}

ANSWERS.registerTemplate(
  'cards/wine-card',
  {{{stringifyPartial (read 'cards/wine-card/template') }}}
);
ANSWERS.registerComponentType(wine_cardCardComponent);
